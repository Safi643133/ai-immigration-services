...
export type ProgressStep = 
  ...
  | 'form_step_4'
  | 'form_step_4_progress'
  | 'form_step_4_completed'
  | 'form_step_5'
  | 'form_step_5_progress'
  | 'form_step_5_completed'
  | 'form_step_6'
  | 'form_step_6_progress'
  | 'form_step_6_completed'
  | 'form_step_7'
  | 'form_step_7_progress'
  | 'form_step_7_completed'
  | 'form_step_8'
  | 'form_step_8_progress'
  | 'form_step_8_completed'
  | 'form_step_9'
  | 'form_step_9_progress'
  | 'form_step_9_completed'
  | 'form_step_10'
  | 'form_step_10_progress'
  | 'form_step_10_completed'
  | 'form_step_11'
  | 'form_step_11_progress'
  | 'form_step_11_completed'
  | 'form_step_12'
  | 'form_step_12_progress'
  | 'form_step_12_completed'
  | 'form_step_13'
  | 'form_step_13_progress'
  | 'form_step_13_completed'
  | 'form_step_14'
  | 'form_step_14_progress'
  | 'form_step_14_completed'
  | 'form_step_15'
  | 'form_step_15_progress'
  | 'form_step_15_completed'
  | 'form_step_16'
  | 'form_step_16_progress'
  | 'form_step_16_completed'
  | 'form_step_17'
  | 'form_step_17_progress'
  | 'form_step_17_completed'
  | 'form_step_3_filling'
  | 'form_step_3_progress'
  | 'form_step_3_completed'
  | 'form_step_3'
